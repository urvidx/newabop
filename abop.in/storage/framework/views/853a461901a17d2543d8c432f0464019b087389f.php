                                        ...
                                        <div class="wt-userlistinghold wt-featured wt-userlistingvtwo del-job-<?php echo e($job->id); ?>">
                                            ...
                                            <div class="wt-userlistingcontent">
                                                <div class="wt-contenthead">
                                                    ...
                                                    <?php if(!empty($job->price) || !empty($location['title']) || !empty($job->project_type) || !empty($job->duration) ): ?>
                                                        <ul class="wt-saveitem-breadcrumb wt-userlisting-breadcrumb">
                                                            ...
                                                            <?php endif; ?>
                                                            <?php if(!empty($job->duration) && !is_array($duration)): ?>
                                                ...
                                                <div class="wt-rightarea la-pending-jobs">
                                                    ...
                                                    <?php elseif($job->status == 'posted'): ?>
                                                        <?php if(\Schema::hasColumn('jobs', 'expiry_date') && !empty($job->expiry_date)): ?>
                                                            <?php $expiry = Carbon\Carbon::parse($job->expiry_date); ?>
                                                            <?php if($expiry->lessThan(Carbon\Carbon::now())): ?>
                                                                <div class="wt-hireduserstatus">
                                                                    <h4><?php echo e(trans('lang.project_status.expired')); ?></h4>
                                                                </div>
                                                            <?php else: ?>
                                                                <div class="wt-hireduserstatus">
                                                                    <h4><?php echo e($job->status); ?></h4>
