        ...
        <div id="wt-verticalscrollbar" class="wt-verticalscrollbar">
            ...
            <nav id="wt-navdashboard" class="wt-navdashboard">
                <ul>
                    ...
                    <?php endif; ?>
                    <?php if($role === 'salesPerson' || $role === 'manager'): ?>
                        <li>
                            <a href="<?php echo e(route('userListing')); ?>">
                                <i class="ti-user"></i>
                                <span><?php echo e(trans('lang.manage_users')); ?></span>
                    ...
                    <?php endif; ?>
                    <?php if($role === 'employer' || $role === 'boutique' ): ?>
                        <li>
                        ...
                        <?php elseif($role === 'boutique'): ?>
                            <li class="menu-item-has-children">
                                ...
                                <ul class="sub-menu">
                                    <li><hr><a href="<?php echo e(url('boutique/jobs/completed')); ?>"><?php echo e(trans('lang.completed_projects')); ?></a></li>
                                    <li><hr><a href="<?php echo e(url('boutique/jobs/cancelled')); ?>"><?php echo e(trans('lang.cancelled_projects')); ?></a></li>
                                    <li><hr><a href="<?php echo e(url('boutique/jobs/hired')); ?>"><?php echo e(trans('lang.ongoing_projects')); ?></a></li>
                                </ul>
                            </li>
                            <?php if(Helper::getAccessType() == 'both' || Helper::getAccessType() == 'services'): ?>
                                <li class="menu-item-has-children">
                            ...
                            <?php if($payment_module === 'true' ): ?>
                                <li class="menu-item-has-children">
                                    ...
                                    <ul class="sub-menu">
                                        <li><hr><a href="<?php echo e(url('boutique/package/invoice')); ?>"><?php echo e(trans('lang.pkg_inv')); ?></a></li>
                                    </ul>
                                </li>
                                <li>
                                    <a href="<?php echo e(url('dashboard/packages/'.$role)); ?>">
