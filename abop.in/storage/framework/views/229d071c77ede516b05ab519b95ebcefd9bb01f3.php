<?php echo Form::open(['url' => '', 'class' =>'wt-formtheme wt-userform', 'id' =>'general-setting-form', '@submit.prevent'=>'submitGeneralSettings']); ?>
    ...
    <div class="wt-settingscontent">
        <div class="wt-formtheme wt-userform">
            <div class="form-group">
                <?php echo Form::text('settings[0][price_range]', e($price_range), array('class' => 'form-control', 'placeholder'=>trans('lang.max_price_range'))); ?>
    ...
    <div class="wt-securitysettings wt-tabsinfo wt-haslayout">
        <div class="wt-tabscontenttitle">
            <h2><?php echo e(trans('lang.loader')); ?></h2>
        </div>
        <div class="wt-settingscontent">
            <div class="wt-description">
                <p><?php echo e(trans('lang.enable_disable_loader_note')); ?></p>
            </div>
            <ul class="wt-accountinfo">
                <li>
                    <switch_button v-model="enable_loader"><?php echo e(trans('lang.enable_disable_loader')); ?></switch_button>
    ...
    <div class="wt-securitysettings wt-tabsinfo wt-haslayout">
        <div class="wt-tabscontenttitle">
            <h2><?php echo e(trans('lang.freelancer_earnings')); ?></h2>
        </div>
        <div class="wt-settingscontent">
            <div class="wt-description">
                <p><?php echo e(trans('lang.show_hide_freelancer_earnings_note')); ?></p>
            </div>
            <ul class="wt-accountinfo">
                <li>
                    <switch_button v-model="show_earnings"><?php echo e(trans('lang.show_hide_freelancer_earning')); ?></switch_button>
