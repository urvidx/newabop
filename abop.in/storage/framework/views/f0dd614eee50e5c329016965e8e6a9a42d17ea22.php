                            ...
                            <div class="wt-awardsholder" id="wt-awards">
                                <?php echo Form::open(['url' => url('freelancer/store-project-award-settings'), 'class' =>'wt-formtheme wt-userform wt-formprojectinfo', 'id' => 'awards_projects', '@submit.prevent' => 'submitAwardsProjects']); ?>
                                    ...
                                    <div class="wt-addprojectsholder wt-tabsinfo">
                                            <?php echo $__env->make('back-end.admin.users.profile-settings.projects-awards.projects', \Illuminate\Support\Arr::except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                                    </div>
                                    <div class="wt-addprojectsholder wt-tabsinfo la-awards">
                                            <?php echo $__env->make('back-end.admin.users.profile-settings.projects-awards.awards', \Illuminate\Support\Arr::except(get_defined_vars(), array('__data', '__path')))->render(); ?> 
                                    </div>
