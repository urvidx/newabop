			...
			<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12 float-right" id="services">
				...
				<div class="wt-dashboardbox wt-dashboardservcies">
					<div class="wt-dashboardboxtitle wt-titlewithsearch">
						<h2><?php echo e(trans('lang.cancelled_services')); ?></h2>
					</div>
											...
											<td>
												<span class="bt-content">
													<div class="wt-actionbtn">
														<a href="javascript:void(0);" v-on:click.prevent="showReview('<?php echo e($service->pivot_id); ?>')" class="wt-viewinfo wt-btnhistory wt-reasonbtn"><?php echo e(trans('lang.reason')); ?></a>
													</div>
												</span>
											</td>
											<td data-th="Action">
												<span class="bt-content">
													<div class="wt-actionbtn">
														<a href="<?php echo e(url('freelancer/service/'.$service->pivot_id.'/cancelled')); ?>" class="wt-viewinfo wt-btnhistory"><?php echo e(trans('lang.show_history')); ?></a>
													</div>
												</span>
											</td>
										</tr>
										<b-modal ref="myModalRef-<?php echo e($service->pivot_id); ?>" class="wt-uploadrating" hide-footer title="<?php echo e(trans('lang.rejection_reason')); ?>" v-cloak>
