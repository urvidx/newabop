...
//         Route::get('/', 'HomeController@fakeIndex')->name('fakeIndex');
//     } else {
...
//Route::get('homepage', 'HomeController@index')->name('home');
//Route::get('/', 'HomeController@fakeIndex')->name('fakeIndex');
// Route for check if phone no. exixts then login or create new user
Route::post('/phoneLogin','HomeController@phoneLogin')->name('phoneLogin');
Route::get('/available/phone_numer','HomeController@checkPhoneAvail')->name('checkPhoneAvail');
Route::post('/registerAsClient','Auth\RegisterController@registerAsClient')->name('registerAsClient');
Route::post('/postJobFromHome','JobController@postJobFromHome')->name('postJobFromHome');
Route::get(
    '/',
    function () {
...
Route::group(
    ...
    function () {
        ...
        Route::get('userfree/experience-education/{id}', 'UserController@experienceEducationSettings')->name('userfree.experienceEducation');
        Route::post('userfree/store-experience-settings/{id}', 'UserController@storeExperienceEducationSettings');
        Route::get('user/get-freelancer-experiences/{id}', 'UserController@getFreelancerExperiences');
        Route::get('user/get-freelancer-educations/{id}', 'UserController@getFreelancerEducations');
        Route::get('userfree/project-awards/{id}', 'UserController@projectAwardsSettings')->name('userfree.projectAwards');
        Route::get('userfree/get-freelancer-awards/{id}', 'UserController@getFreelancerAwards');
        Route::get('userfree/get-freelancer-projects/{id}', 'UserController@getFreelancerProjects');
        Route::post('userFree/store-project-award-settings/{id}', 'UserController@storeProjectAwardSettings');
        ...
        Route::post('admin/saveSliderImage','SiteManagementController@saveSliderImages')->name('saveSliderImage');
        Route::post('admin/editSliderImage','SiteManagementController@editSliderImage')->name('editSliderImage');
        Route::post('admin/deleteSliderImage','SiteManagementController@deleteSliderImage')->name('deleteSliderImage');

        Route::post('admin/saveWorkDetail','SiteManagementController@saveWorkDetail')->name('saveWorkDetail');
        Route::post('admin/deleteWorkImage/{id}','SiteManagementController@deleteWorkImage')->name('deleteWorkImage');
        Route::post('admin/updateWorkDetail','SiteManagementController@updateWorkDetail')->name('updateWorkDetail');

    }
);

Route::group(
    ['middleware' => ['role:admin|manager|salesPerson']],
    function () {
        Route::get('users', 'UserController@userListing')->name('userListing');
        Route::get('users/editUser/{id}', 'UserController@edit')->name('usersEdit');
        Route::post('postEditUser','UserController@postEditUser')->name('users.postEditUser');
        Route::get('addUser','UserController@addUser')->name('users.addUser');
        Route::post('postAddUser','UserController@postAddUser')->name('users.postAddUser');
        Route::get('user/edit/{id}','UserController@editUser')->name('editUserProfile');
        Route::get('userEmp/edit/{id}','UserController@editUserEmp')->name('EmpeditUserProfile');
        Route::get('user/update/skills','UserController@freelancerUpdateSkills')->name('freelancerUpdateSkills');
        Route::post('admin/upload-temp-image', 'UserController@uploadTempImage');
        Route::post('admin/employer/store-profile-settings/{id}', 'UserController@EmployerstoreProfileSettings');
        Route::post('admin/store-profile-settings', 'UserController@storeProfileSettings');
        Route::post('admin/store-profile-settingsboutique/{id}', 'UserController@storeProfileSettingsFreelancer')->name('storeProfileSettingsFreelancer'); 
    }
...
Route::group(
    ['middleware' => ['role:boutique|admin']],
    function () {
        if (Helper::getAccessType() == 'both' || Helper::getAccessType() == 'services') {
            Route::get('boutique/services/{status}', 'FreelancerController@showServices')->name('ServiceListing');
            Route::get('boutique/service/{id}/{status}', 'FreelancerController@showServiceDetail')->name('ServiceDetail');
        }
        Route::post('services/change-status', 'ServiceController@changeStatus');
        Route::get('boutique/dashboard/edit-service/{id}', 'ServiceController@edit')->name('edit_service');
        ...
        Route::post('boutique/dashboard/delete-service', 'ServiceController@destroy');
...
// Freelancer Routes
Route::group(
    ['middleware' => ['role:boutique']],
    function () {
        Route::get('/get-freelancer-skills', 'SkillController@getFreelancerSkills');
        Route::get('/get-skills', 'SkillController@getSkills');
        Route::get('boutique/dispute/{slug}', 'UserController@raiseDispute');
        Route::post('boutique/store-dispute', 'UserController@storeDispute');
        Route::get('boutique/dashboard/experience-education', 'FreelancerController@experienceEducationSettings')->name('experienceEducation');
        Route::get('boutique/dashboard/project-awards', 'FreelancerController@projectAwardsSettings')->name('projectAwards');
        Route::post('boutique/store-profile-settings', 'FreelancerController@storeProfileSettings')->name('freelancerProfileSetting');
        Route::post('boutique/store-experience-settings', 'FreelancerController@storeExperienceEducationSettings');
        Route::post('boutique/store-project-award-settings', 'FreelancerController@storeProjectAwardSettings');
        Route::get('boutique/get-freelancer-skills', 'FreelancerController@getFreelancerSkills');
        Route::get('boutique/get-freelancer-experiences', 'FreelancerController@getFreelancerExperiences');
        Route::get('boutique/get-freelancer-projects', 'FreelancerController@getFreelancerProjects');
        Route::get('boutique/get-freelancer-educations', 'FreelancerController@getFreelancerEducations');
        Route::get('boutique/get-freelancer-awards', 'FreelancerController@getFreelancerAwards');
        Route::get('boutique/jobs/{status}', 'FreelancerController@showFreelancerJobs');
        Route::get('boutique/job/{slug}', 'FreelancerController@showOnGoingJobDetail')->name('showOnGoingJobDetail');
        Route::get('boutique/proposals', 'FreelancerController@showFreelancerProposals')->name('showFreelancerProposals');
        Route::get('boutique/dashboard', 'FreelancerController@freelancerDashboard')->name('freelancerDashboard');
        Route::get('boutique/profile', 'FreelancerController@index')->name('personalDetail');
        Route::post('boutique/upload-temp-image', 'FreelancerController@uploadTempImage');
        Route::get('boutique/dashboard/post-service', 'ServiceController@create')->name('freelancerPostService');
        Route::get('boutique/payout-settings', 'FreelancerController@payoutSettings')->name('FreelancerPayoutsSettings');
        Route::get('boutique/payouts', 'FreelancerController@getPayouts')->name('getFreelancerPayouts');
    }
);
// Employer|Freelancer Routes
Route::group(
    ['middleware' => ['role:employer|boutique|admin']],
    function () {
        ...
        Route::get('boutique/{type}/invoice', 'UserController@getFreelancerInvoices')->name('freelancerInvoice');
