        ...
        <div id="wt-verticalscrollbar" class="wt-verticalscrollbar">
            ...
            <nav id="wt-navdashboard" class="wt-navdashboard">
                <ul>
                    ...
                    @endif
                    @if ($role === 'employer' || $role === 'boutique' )
                        <li>
                        ...
                        @elseif ($role === 'boutique')
                            <li class="menu-item-has-children">
                                ...
                                <ul class="sub-menu">
                                    <li><hr><a href="{{{ url('boutique/jobs/completed') }}}">{{ trans('lang.completed_projects') }}</a></li>
                                    <li><hr><a href="{{{ url('boutique/jobs/cancelled') }}}">{{ trans('lang.cancelled_projects') }}</a></li>
                                    <li><hr><a href="{{{ url('boutique/jobs/hired') }}}">{{ trans('lang.ongoing_projects') }}</a></li>
                                </ul>
                            </li>
                            @if (Helper::getAccessType() == 'both' || Helper::getAccessType() == 'services')
                                <li class="menu-item-has-children">
                            ...
                            @if ($payment_module === 'true' )
                                <li class="menu-item-has-children">
                                    ...
                                    <ul class="sub-menu">
                                        <li><hr><a href="{{{ url('boutique/package/invoice') }}}">{{ trans('lang.pkg_inv') }}</a></li>
                                    </ul>
                                </li>
                                <li>
                                    <a href="{{{ url('dashboard/packages/'.$role) }}}">
