...
<head>
    ...
    <link href="{{ asset('css/customAbop.css') }}" rel="stylesheet">
	@stack('stylesheets')
                ...
                <div class="wt-haslayout reqlq1">
                    ...
                    <div class="form-group form-group-half wt-formwithlabel">
                      <span class="wt-select">
                        {!! Form::select('job_duration', $job_duration, null, array('class' => 'form-control', 'placeholder' => trans('lang.select_job_duration'))) !!}
                      </span>
                    </div>
                    <div class="form-group form-group-half wt-formwithlabel">
                      <span class="wt-select">
                        {!! Form::select('categories[]', $categories2, array('class' => 'form-control', 'placeholder' => trans('lang.select_job_cats'))) !!}
                      </span>
                    </div>
                    <div class="form-group wt-jobdetails wt-tabsinfo">
                        ...
                        <div class="wt-formtheme wt-userform wt-userformvtwo">
                            {!! Form::textarea('description', null, ['class' => 'form-control wt-tinymceeditor', 'id' => 'wt-tinymceeditor', 'placeholder' => trans('lang.job_dtl_note')]) !!}
                        </div>
                    </div>
          ...
          <form method="post" autocomplete="off" id="registeryourself" class="registeryourself" action="javascript:void(0)" enctype="multipart/form-data">
            ...
            <!-- <fieldset class="wt-registerformgroup"> -->
                ...
                <div class="wt-haslayout layout1forreg">
                    ...
                    <div class="form-group form-group-half">
                        <input type="text" name="first_name" required="required" autocomplete="off" id="regfirst_name" class="form-control" placeholder="{{{ trans('lang.ph_first_name') }}}">
                    </div>
                    <div class="form-group form-group-half">
                        <input type="text" name="last_name" autocomplete="off" id="reglast_name" class="form-control" placeholder="{{{ trans('lang.ph_last_name') }}}">
                    </div>
                    <div class="form-group ">
                        <input id="reguser_email" type="email" autocomplete="off" class="form-control" name="email" placeholder="{{{ trans('lang.ph_email') }}} (optional)" value="{{ old('email') }}">
                    </div>
                    ...
                    <div class="form-group form-group-half">
	                    <input id="password" type="password" autocomplete="off" class="form-control" name="password" placeholder="{{{ trans('lang.ph_pass') }}}">
	                </div>
	                <div class="form-group form-group-half">
	                    <input id="password-confirm" type="password" autocomplete="off" class="form-control" name="confirmPassword" placeholder="{{{ trans('lang.ph_retry_pass') }}}" >
	                </div>
                    ...
                    <div class="form-group">
                        <button type="submit" class="wt-btn submitRegisterButton">{{{  trans('lang.btn_startnow') }}}</button>
                    </div>
                </div>
            <!-- </fieldset> -->
            </form>
...
@endguest
	...
	<script type="text/javascript">
		var role = '@php @$user = auth()->user(); print_r(@$user["roles"][0]["name"]); @endphp';
		if(role == 'admin')
        {
