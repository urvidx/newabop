                ...
                <div class="wt-dashboardbox wt-dashboardtabsholder wt-accountsettingholder">
                    ...
                    <div class="wt-tabscontent tab-content">
                        ...
                        <div class="wt-securityhold tab-pane la-slider-settings" id="wt-slider">
                            @include('back-end.admin.home-page-settings.slider_settings')
                        </div>

                        <div class="wt-securityhold tab-pane la-slider-settings" id="wt-workDetail">
                            @include('back-end.admin.home-page-settings.workDetail_settings')
                        </div>
...
$.ajax({
   ...
   success:function(data){
       ...
       //$('#ImgOri').attr('src', "/profile_images/"+ data.photo_name);
        var url = "{{url('/public/sliderImages/thumbnail/')}}"+'/'+data.image;
...
$.ajax({
   ...
   success:function(data){
       ...
       //$('#ImgOri').attr('src', "/profile_images/"+ data.photo_name);
        var url = "{{url('/public/uploads/workdetails/')}}"+'/'+data.icon;
       // $('#ImgThumb').attr('src', "/profile_images/thumbnail/"+ data.photo_name);
       deletUrl = "{{url('admin/deleteWorkImage')}}"+'/'+data.id;
 ...
 $('body').on('click','.removeSlide',function(e){
    ...
    if (id != '') {
        $.ajax({
            ...
            type: 'POST',
            url: "{{url('admin/deleteSliderImage')}}",
            data:{id:id},
            success:function(res){
  ...
  $('body').on('click','.deletebtnwork',function(e){
    ...
    if (id != '') {
        $.ajax({
            ...
            type: 'POST',
            url: "{{url('admin/deleteWorkImage')}}"+'/'+id,
            data:{id:id},
            success:function(res){
...
$('body').on('submit','#editWorkForm',function(e){ 
    ...
    $.ajax({
        ...
        type:'POST',
        url: "{{url('admin/updateWorkDetail')}}",
        data:formData,
        cache:false,
        contentType: false,
        processData: false,
