            ...
            <div class="col-xs-6 col-sm-12 col-md-6 col-lg-6 float-right">
                ...
                <div style="padding: 20px;" class="wt-dashboardbox">
                	<div class="wt-dashboardboxcontent wt-categoriescontentholder">
                                <form method="POST" action="{{route('users.postAddUser')}}" class="wt-formtheme wt-formregister" id="register_form">
                                    @csrf
                                    <fieldset class="wt-registerformgroup">
                                        <div class="wt-haslayout">
                                            ...
                                            <div class="form-group form-group-half">
                                                <input type="text" name="first_name" class="form-control" placeholder="{{{ trans('lang.ph_first_name') }}}" >
                                                <span class="help-block">
                                                    <strong ><?php echo @$errors->first('first_name'); ?></strong>
                                                </span>
                                            </div>
                                            <div class="form-group form-group-half">
                                                <input type="text" name="last_name" class="form-control" placeholder="{{{ trans('lang.ph_last_name') }}}" >
                                                <span class="help-block" >
                                                    <strong ><?php echo @$errors->first('last_name'); ?></strong>
                                                </span>
                                            </div>
                                            <div class="form-group form-group-half">
                                                <input id="user_email" type="email" class="form-control" name="email" placeholder="{{{ trans('lang.ph_email') }}}" value="{{ old('email') }}" >
                                                <span class="help-block" >
                                                    <strong ><?php echo @$errors->first('email'); ?></strong>
                                                </span>
                                            </div>
                                            <div class="form-group form-group-half">
                                                <input id="mobile_number" type="number" class="form-control" name="mobile_number" placeholder="91 Enter Mobile Number with Country code" value="{{ old('mobile_number') }}" >
                                                <span class="help-block" >
                                            ...
                                            @if (!empty($locations))
                                                <div class="form-group">
                                                    <span class="wt-select">
                                                        {!! Form::select('locations', $locations, null, array('placeholder' => trans('lang.select_locations'))) !!}
                                                        <span class="help-block" >
                                        ...
                                        <fieldset class="wt-formregisterstart">
                                            ...
                                            @if(!empty($roles))
                                                ...
                                                <ul class="wt-accordionhold wt-formaccordionhold accordion">
                                                    ...
                                                    @endphp
                                                    @foreach ($roles as $key => $role)
                                                        @if($authUser->hasRole(['salesPerson']))
                                                            @php $array = [1,2,4,5] @endphp
                                                        @elseif($authUser->hasRole(['manager']))
                                                            @php $array = [1,4,5] @endphp
                                                        @else
                                                            @php $array = [1] @endphp
                                                        @endif
