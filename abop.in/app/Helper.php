...
class Helper extends Model
{
    ...
    {
        $list = array(
            '0-100' => trans('lang.freelancer_hourly_rate.0_100'),
            '100_200' => trans('lang.freelancer_hourly_rate.100_200'),
            '200_300' => trans('lang.freelancer_hourly_rate.200_300'),
            '300_400' => trans('lang.freelancer_hourly_rate.300_400'),
            '400_500' => trans('lang.freelancer_hourly_rate.400_500'),
            '500_600' => trans('lang.freelancer_hourly_rate.500_600'),
            '600_700' => trans('lang.freelancer_hourly_rate.600_700'),
            '700_800' => trans('lang.freelancer_hourly_rate.700_800'),
            '800_900' => trans('lang.freelancer_hourly_rate.800_900'),
            '900_1000' => trans('lang.freelancer_hourly_rate.900_1000'),
            '1000_0' => trans('lang.freelancer_hourly_rate.1000_0'),
        );
        if (!empty($key) && array_key_exists($key, $list)) {
            return $list[$key];
        } else {
    ...
    public static function getAuthRoleName()
    {
        if (Auth::user()) {
            if (Auth::user()->getRoleNames()->first() == 'freelancer') {
                ...
                return 'Manager';
            } elseif (Auth::user()->getRoleNames()->first() == 'salesPerson') {
