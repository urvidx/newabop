                            ...
                            <form class="wt-formtheme wt-formsearch change-payout-status" id="change_job_status">
                                <fieldset>
                                    <div class="form-group">
                                        ...
                                        <a href="javascrip:void(0);" class="wt-searchgbtn" @click.prevent='changePayoutStatus(<?php echo e($payout->id); ?>, <?php echo e(json_encode($payout->projects_ids)); ?>)'><i class="fa fa-check"></i></a>
                                    </div>
                                </fieldset>
                            </form>
                        </span>
