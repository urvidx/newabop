...
<div class="wt-formtheme">
    <fieldset>
        <div class="form-group">
            <input type="text" name="full_address" class="form-control" placeholder="Enter Full Address" value="{{@$profile->full_address}}">
        </div>
        <div class="form-group form-group-half">
            <span class="wt-select">
                {!! Form::select('location', $locations, $userDetails->location_id ,array('class' => '', 'placeholder' => trans('lang.select_location'))) !!}
            </span>
        </div>
        <div class="form-group form-group-half">
