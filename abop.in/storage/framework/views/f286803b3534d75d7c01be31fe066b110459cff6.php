            ...
            <div class="col-xs-6 col-sm-12 col-md-6 col-lg-6 float-right">
                ...
                <div style="padding: 20px;" class="wt-dashboardbox">
                	<div class="wt-dashboardboxcontent wt-categoriescontentholder">
                                <form method="POST" action="<?php echo e(route('users.postEditUser')); ?>" class="wt-formtheme wt-formregister" id="register_form">
                                    <?php echo csrf_field(); ?>
                                    <fieldset class="wt-registerformgroup">
                                        <div class="wt-haslayout">
                                            ...
                                            <div class="form-group form-group-half">
                                                <input type="text" name="first_name" class="form-control" placeholder="<?php echo e(trans('lang.ph_first_name')); ?>" value="<?php echo e($user->first_name); ?>" >
                                            ...
                                            <div class="form-group form-group-half">
                                                <input type="text" name="last_name" class="form-control" placeholder="<?php echo e(trans('lang.ph_last_name')); ?>" value="<?php echo e($user->last_name); ?>" >
                                                <span class="help-block" >
                                                    <strong ><?php echo @$errors->first('last_name'); ?></strong>
                                                </span>
                                            </div>
                                            <div class="form-group form-group-half">
                                                <input id="user_email" type="email" class="form-control" name="email" placeholder="<?php echo e(trans('lang.ph_email')); ?>" value="<?php echo e($user->email); ?><?php echo e(old('email')); ?>" >
                                                <span class="help-block" >
                                                    <strong ><?php echo @$errors->first('email'); ?></strong>
                                                </span>
                                            </div>
                                            <div class="form-group form-group-half">
                                                <input id="mobile_number" type="number" class="form-control" name="mobile_number" placeholder="91 Enter Mobile Number with Country code" value="<?php echo e($user->mobile_number); ?><?php echo e(old('mobile_number')); ?>" >
                                                <span class="help-block" >
                                            ...
                                            <?php if(!empty($locations)): ?>
                                                <div class="form-group">
                                                    <span class="wt-select">
                                                        <?php echo Form::select('locations', $locations, $user->location_id, array('placeholder' => trans('lang.select_locations'))); ?>
                                                        ...
                                                        <?php if(!in_array($role['id'], [1,2,3])): ?>
                                                            <li>
                                                                <div class="wt-accordiontitle" id="headingOne" data-toggle="collapse" data-target="#collapseOne">
                                                                    <span class="wt-radio">
                                                                    <input id="wt-company-<?php echo e($key); ?>" type="radio" name="role" value="<?php echo e($role['role_type']); ?>" <?php echo e(($rolea->id == $role['id'])? 'checked' : ''); ?> >
