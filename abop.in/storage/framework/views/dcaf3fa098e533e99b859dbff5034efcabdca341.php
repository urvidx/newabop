                            ...
                            <div class="wt-dashboardboxcontent">
                                <div class="wt-jobdescription wt-tabsinfo">
                                    ...
                                    <div class="wt-formtheme wt-userform wt-userformvtwo la-job-details-form">
                                        <fieldset>
                                            ...
                                            <job-expiry 
                                                :db_expiry_date="'<?php echo e($job->expiry_date); ?>'" 
                                ...
                                <div class="wt-jobskills wt-tabsinfo">
                                    ...
                                    <div class="wt-divtheme wt-userform wt-userformvtwo">
                                        <div class="form-group">
                                            <span class="wt-select">
                                                <?php echo Form::select('categories[]', $categories, $job->categories, array('class' => 'chosen-select', 'multiple', 'data-placeholder' => trans('lang.select_job_cats'))); ?>
                                ...
                                <div class="wt-jobskills wt-tabsinfo">
                                    ...
                                    <div class="wt-divtheme wt-userform wt-userformvtwo">
                                        <div class="form-group">
                                            <span class="wt-select">
                                                <?php echo Form::select('languages[]', $languages, $job->languages, array('class' => 'chosen-select', 'multiple', 'data-placeholder' => trans('lang.select_lang'))); ?>
                                ...
                                <div class="wt-joblocation wt-tabsinfo la-location-edit">
                                    ...
                                    <div class="wt-formtheme wt-userform">
                                        <fieldset>
                                            ...
                                            <div class="form-group form-group-half">
                                                <?php echo Form::text( 'address', $job->address, ['id'=>"pac-input", 'class' =>'form-control', 'placeholder' => trans('lang.your_address')] ); ?>
                                            ...
                                            <div class="form-group form-group-half">
                                                <?php echo Form::text( 'longitude', $job->longitude, ['id'=>"lng-input", 'class' =>'form-control', 'placeholder' => trans('lang.enter_logitude')]); ?>

                                            </div>
                                            <div class="form-group form-group-half">
                                                <?php echo Form::text( 'latitude', $job->latitude, ['id'=>"lat-input", 'class' =>'form-control', 'placeholder' => trans('lang.enter_latitude')]); ?>
