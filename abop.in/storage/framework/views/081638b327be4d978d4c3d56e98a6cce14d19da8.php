                            ...
                            <div class="wt-educationholder" id="wt-education">
                                <?php echo Form::open(['url' => url('freelancer/store-experience-settings'), 'class' =>'wt-formtheme wt-userform', 'id' => 'experience_form', '@submit.prevent'=>'submitExperienceEduction']); ?>
                                    ...
                                    <div class="wt-userexperience wt-tabsinfo">
                                        <?php if(file_exists(resource_path('views/extend/back-end/freelancer/profile-settings/experience-education/experience.blade.php'))): ?> 
                                            <?php echo $__env->make('extend.back-end.freelancer.profile-settings.experience-education.experience', \Illuminate\Support\Arr::except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                                        <?php else: ?> 
                                    ...
                                    <div class="wt-userexperience wt-tabsinfo">
                                        <?php if(file_exists(resource_path('views/extend/back-end/freelancer/profile-settings/experience-education/education.blade.php'))): ?> 
                                            <?php echo $__env->make('extend.back-end.freelancer.profile-settings.experience-education.education', \Illuminate\Support\Arr::except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                                        <?php else: ?> 
