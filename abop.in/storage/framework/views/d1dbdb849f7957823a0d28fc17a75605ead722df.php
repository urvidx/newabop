                            ...
                            <div class="wt-joblocation wt-tabsinfo">
                                ...
                                <div class="wt-formtheme wt-userform">
                                    <fieldset>
                                        ...
                                        <div class="form-group form-group-half">
                                            <?php echo Form::text( 'address', null, ['id'=>"pac-input", 'class' =>'form-control', 'placeholder' => trans('lang.your_address')] ); ?>
                                        ...
                                        <div class="form-group form-group-half">
                                            <?php echo Form::text( 'longitude', null, ['id'=>"lng-input", 'class' =>'form-control', 'placeholder' => trans('lang.enter_logitude')]); ?>

                                        </div>
                                        <div class="form-group form-group-half">
                                            <?php echo Form::text( 'latitude', null, ['id'=>"lat-input", 'class' =>'form-control', 'placeholder' => trans('lang.enter_latitude')]); ?>
