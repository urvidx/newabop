                        ...
                        <div class="col-xs-12 col-sm-12 col-md-7 col-lg-7 col-xl-8 float-left">
                            ...
                            <div class="wt-userlistingholder wt-userlisting wt-haslayout relative">
                                <div class="wt-userlistingtitle absolute pagintotalRes">
                                    <?php if(!empty($users)): ?>
                                        <span><?php echo e(trans('lang.01')); ?> <?php echo e($users->count()); ?> of <?php echo e(\App\User::role('boutique')->count()); ?> results <?php if(!empty($keyword)): ?> for <em>"<?php echo e($keyword); ?>"</em> <?php endif; ?></span>
                                    <?php endif; ?>
                                </div>
                                <?php if(!empty($users)): ?>
                                                        ...
                                                        <?php if(!empty($freelancer->location)): ?>
                                                            <li>
                                                                <span>
                                                                    ...
                                                                    <img src="<?php echo e(asset($flag)); ?>" alt="Flag"> 
                                                                    <?php echo e(!empty($freelancer->location->title) ? $freelancer->location->title : ''); ?>
